...
?>
<?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' => 'add', 'admin' => true), 'novalidate' => true, 'shortcut' => 'on')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="box box-solid box-primary">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group required<?php echo $this->Admin->errorClass('username'); ?>">
                                                            <label>用户名</label>
                                                            <div class="input-group col-xs-12 col-md-6">
                                                            <?php echo $this->Form->text('username', array('placeholder' => '用户名', 'class' => 'form-control')); ?>
                                                            <span class="text-light-blue">保存后不可修改，支持字母、数字组合，长度6-12位。</span>
                                                            </div>

                                                            <?php echo $this->Admin->error('username'); ?>
                                                        </div>
                                                        ...
                                                        <div class="form-group required<?php echo $this->Admin->errorClass('password'); ?>">
                                                            <label>密码</label>
                                                            <div class="input-group col-xs-12 col-md-6">
                                                            <?php echo $this->Form->password('password', array('placeholder' => '密码', 'class' => 'form-control')); ?>
                                                            <span class="text-light-blue">支持字母、数字、下划线组合，长度6-32位。</span>
                                                            </div>
                                                            <?php echo $this->Admin->error('password'); ?>
                                                        </div>

                                                        <div class="form-group required<?php echo $this->Admin->errorClass('confirm_password'); ?>">
                                                            <label>确认密码</label>
                                                            <div class="input-group col-xs-12 col-md-6">
                                                            <?php echo $this->Form->password('confirm_password', array('placeholder' => '确认密码', 'class' => 'form-control')); ?>
                                                            </div>
                                                        ...
                                                        <div class="form-group<?php echo $this->Admin->errorClass('avatar'); ?>">
                                                            ...
                                                            <?php echo $this->Form->text('avatar', array('placeholder' => '头像路径', 'class' => 'form-control')); ?>
                                                                <div class="input-group-btn">
                                                                    ...
                                                                    <input type="file" name="avatar_file" id="avatar-file">
                                                                    </div>
                                                                </div>
                                                            </div>
