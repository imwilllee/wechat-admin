 ...
 */
	Configure::write('Security.salt', 'zAIML02s972P2E8U5OQSjM4mLARGFQYQ2cmzHs0k');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '304360344622883519079600464381');
